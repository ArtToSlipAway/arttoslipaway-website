...
Это мой собственный рабочий проект, созданный для автоматизации пути клиента
тату-мастера: от просмотра портфолио и отправки заявки до CRM, клиентского
кабинета и защищённого обмена файлами.

В проекте я отвечал за:

- постановку бизнес-задач и проектирование пользовательских сценариев;
- структуру сайта, UX, визуальную часть и требования к административной CRM;
- проектирование форм заявки, статусов, клиентского кабинета и работы с файлами;
- настройку VPS, reverse proxy, systemd, PostgreSQL, HTTPS и резервного копирования;
- тестирование пользовательских сценариев и проверку production после изменений;
- диагностику ошибок, контроль безопасности, прав доступа и серверных процессов;
- подготовку очищенной воспроизводимой версии проекта для GitHub.

Разработка велась с использованием AI-инструментов как помощника для написания,
рефакторинга и ревью кода. Архитектурные и продуктовые решения, постановку задач,
проверку результата, тестирование, диагностику и внедрение изменений на рабочем
сервере я выполнял и контролировал самостоятельно.
