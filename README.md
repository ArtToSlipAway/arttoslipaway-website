...
Публичная демоверсия намеренно не загружает внешний счётчик. Код событий
воронки остаётся доступен для изучения, но без настроенного production-адаптера
...
Актуальные скриншоты рабочего сайта не содержат персональных данных клиентов,
административных паролей или действующих клиентских ссылок.

### Главная страница

![Главная страница ArtToSlipAway](docs/screenshots/home-desktop.jpg)

| Форма заявки и календарь | Административная панель |
| --- | --- |
| ![Форма заявки ArtToSlipAway](docs/screenshots/request-form.jpg) | ![Панель управления ArtToSlipAway](docs/screenshots/admin-dashboard.jpg) |
